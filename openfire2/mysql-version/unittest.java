...
INSERT INTO ofMucService (subdomain, description, isHidden)
VALUES ('conference','Default chat service',0);"
fi
env:
        - name: MYSQL_USER
valueFrom:
